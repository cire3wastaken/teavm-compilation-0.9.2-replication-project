...
public final class ByteStreams {
	...
	/**
	 * Returns a factory that will supply instances of {@link ByteArrayInputStream}
	 ...
	 */
	@Deprecated
	public static InputSupplier<ByteArrayInputStream> newInputStreamSupplier(final byte[] b, final int off,
			final int len) {
	 ...
	 * @throws IOException if an I/O error occurs
	 * @deprecated Use {@link ByteSource#copyTo(ByteSink)} instead. This method is
	 *             scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	...
	/**
	 * Opens an input stream from the supplier, copies all bytes from the input to
	 * the output, and closes the input stream. Does not close or flush the output
	 * stream.
	 *
	 * @param from the input factory
	 ...
	 * @return the number of bytes copied
	 * @throws IOException if an I/O error occurs
	 * @deprecated Use {@link ByteSource#copyTo(OutputStream)} instead. This method
	...
	/**
	 * Opens an output stream from the supplier, copies all bytes from the input to
	 * the output, and closes the output stream. Does not close or flush the input
	 * stream.
	 *
	 ...
	 * @throws IOException if an I/O error occurs
	 * @since 10.0
	 * @deprecated Use {@link ByteSink#writeFrom(InputStream)} instead. This method
	 *             is scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	...
	/**
	 * Reads all bytes from an input stream into a byte array. The given expected
	 * size is used to create an initial byte array, but if the actual number of
	 * bytes read from the stream differs, the correct result will be returned
	 * anyway.
	 */
	...
	private static final class FastByteArrayOutputStream extends ByteArrayOutputStream {
		/**
		 * Writes the contents of the internal buffer to the given array starting at the
		 * given offset. Assumes the array has space to hold count bytes.
		 */
	 ...
	 * @throws IOException if an I/O error occurs
	 * @deprecated Use {@link ByteSource#read()} instead. This method is scheduled
	...
	/**
	 * Returns a new {@link ByteArrayDataOutput} instance sized to hold {@code size}
	 ...
	 * {@code ByteArrayOutputStream}. The given output stream is not reset before
	 * being written to by the returned {@code ByteArrayDataOutput} and new data
	 * will be appended to any existing content.
	 *
	 * <p>
	 ...
	 *
	 * @deprecated Use {@link ByteSource#size()} instead. This method is scheduled
	 *             for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 * with the same behavior as {@link DataInput#readFully(byte[])}. Does not close
	 * the stream.
	 *
	 * @param in the input stream to read from.
	 ...
	 *                      bytes
	 * @throws IOException  if an I/O error occurs, or the stream does not support
	 *                      skipping
	 */
	 ...
	 * @throws IOException if an I/O error occurs
	 * @deprecated Use {@link ByteSource#read(ByteProcessor)} instead. This method
	 *             is scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 * @throws IOException if an I/O error occurs
	 * @since 12.0
	 * @deprecated Use {@link ByteSource#hash(HashFunction)} instead. This method is
	 *             scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 * {@code b}. This method blocks until {@code len} bytes of input data have been
	 * read into the array, or end of file is detected. The number of bytes read is
	 * returned, possibly zero. Does not close the stream.
	 *
	 * <p>
	 * A caller can detect EOF if the number of bytes read is less than {@code len}.
	 ...
	 * {@code IndexOutOfBoundsException} is thrown. If {@code len} is zero, then no
	 * bytes are read. Otherwise, the first byte read is stored into element
	 * {@code b[off]}, the next one into {@code b[off+1]}, and so on. The number of
	 * bytes read is, at most, equal to {@code len}.
	 *
	 * @param in  the input stream to read from
	 * @param b   the buffer into which the data is read
	 * @param off an int specifying the offset into the data
	 ...
	 * @param offset   the offset in bytes into the underlying stream where the
	 ...
	 */
	@Deprecated
	public static InputSupplier<InputStream> slice(final InputSupplier<? extends InputStream> supplier,
			final long offset, final long length) {
		return asInputSupplier(asByteSource(supplier).slice(offset, length));
	}

	/**
	 * Joins multiple {@link InputStream} suppliers into a single supplier. Streams
	 * returned from the supplier will contain the concatenated data from the
	 * streams of the underlying suppliers.
	 *
	 * <p>
	 * Only one underlying input stream will be open at a time. Closing the joined
	 * stream will close the open underlying stream.
	 *
	 * <p>
	 * Reading from the joined stream will throw a {@link NullPointerException} if
	 ...
	 *         stream data
	 * @deprecated Use {@link ByteSource#concat(Iterable)} instead. This method is
	 *             scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use {@link ByteSource#concat(ByteSource[])} instead. This method
	 *             is scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 *             implementations to extend {@link ByteSource} or provide a method
	 *             for viewing the object as a {@code ByteSource}. This method is
	 *             scheduled for removal in Guava 18.0.
	 */
	@Deprecated
	 ...
	 *             implementations to extend {@link ByteSink} or provide a method
	 *             for viewing the object as a {@code ByteSink}. This method is
	 *             scheduled for removal in Guava 18.0.
	 */
	@Deprecated
