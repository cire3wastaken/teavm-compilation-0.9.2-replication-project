...
final class SortedLists {
	...
	/**
	 * A specification for which index to return if the list contains at least one
	 * element that compares as equal to the key.
	 */
	...
	public enum KeyAbsentBehavior {
		 ...
		 * {@link Collections#binarySearch(List, Object)} when the key isn't
	 ...
	 * Collections.sort(List, Comparator)} method), prior to making this call. If it
	 * is not sorted, the results are undefined.
	 *
	 * <p>
	 * If there are elements in the list which compare as equal to the key, the
	 * choice of {@link KeyPresentBehavior} decides which index is returned. If no
	 * elements compare as equal to the key, the choice of {@link KeyAbsentBehavior}
	 ...
	 * @param presentBehavior the specification for what to do if at least one
	 *                        element of the list compares as equal to the key.
	 * @param absentBehavior  the specification for what to do if no elements of the
	 *                        list compare as equal to the key.
	 * @return the index determined by the {@code KeyPresentBehavior}, if the key is
	 *         in the list; otherwise the index determined by the
